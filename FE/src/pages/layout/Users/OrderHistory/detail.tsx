                                    ...
                                    <tr className="" key={item.product._id}>
                                        <td className="whitespace-nowrap font-medium text-gray-900 flex text-left py-4">
                                            <div className="relative w-[200px]">
                                                <img className="w-full h-auto lg:w-40 object-cover md:w-40" src={item.product.image[0]} alt="" />
                                        ...
                                        <td className="whitespace-nowrap  text-gray-700 py-4 ">
                                            <div className=" items-center ">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className=" bg-yellow-500 flex  gap-3 rounded-full w-4 h-4 opacity-70" style={{ background: item.color }}></span>
                                                </div>
                                            </div>
                ...
                <div className="col-span-1 mx-10 ">
                    ...
                    <div className="mt-4 border border-green-500 rounded-md p-2">
                        ...
                        <div className="mt-4 space-y-2">
                            <div>Trạng thái đơn:              <span className="text-red-500">
